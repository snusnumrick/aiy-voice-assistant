...
class ConversationManager:
    ...
    def get_system_prompt(self):
        ...
        prompt += self.config.get('system_prompt',
                             "Тебя зовут Роби. Ты мой друг и помощник. Ты умеешь шутить и быть саркастичным. "
                             ...
                             "Если по этому запросу не нашел нужной информации, мржешь изменить запрос и повторить."
