...
_RECOGNITIONCLASSIFIER_TRIGGERTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='ON_PARTIAL', index=3, number=3,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_SPEAKERLABELINGOPTIONS_SPEAKERLABELING = _descriptor.EnumDescriptor(
  name='SpeakerLabeling',
  full_name='speechkit.stt.v3.SpeakerLabelingOptions.SpeakerLabeling',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    _descriptor.EnumValueDescriptor(
      name='SPEAKER_LABELING_UNSPECIFIED', index=0, number=0,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='SPEAKER_LABELING_ENABLED', index=1, number=1,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='SPEAKER_LABELING_DISABLED', index=2, number=2,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_sym_db.RegisterEnumDescriptor(_SPEAKERLABELINGOPTIONS_SPEAKERLABELING)
...
_RECOGNITIONCLASSIFIERUPDATE_WINDOWTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='LAST_PARTIAL', index=3, number=3,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_SPEAKERLABELINGOPTIONS = _descriptor.Descriptor(
  name='SpeakerLabelingOptions',
  full_name='speechkit.stt.v3.SpeakerLabelingOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='speaker_labeling', full_name='speechkit.stt.v3.SpeakerLabelingOptions.speaker_labeling', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_STREAMINGOPTIONS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='speaker_labeling', full_name='speechkit.stt.v3.StreamingOptions.speaker_labeling', index=4,
...
_RECOGNIZEFILEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='speaker_labeling', full_name='speechkit.stt.v3.RecognizeFileRequest.speaker_labeling', index=5,
...
_CONVERSATIONANALYSIS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='total_speech_duration_ms', full_name='speechkit.stt.v3.ConversationAnalysis.total_speech_duration_ms', index=8,
      number=9, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='total_speech_ratio', full_name='speechkit.stt.v3.ConversationAnalysis.total_speech_ratio', index=9,
...
_SPEAKERLABELINGOPTIONS.fields_by_name['speaker_labeling'].enum_type = _SPEAKERLABELINGOPTIONS_SPEAKERLABELING
_SPEAKERLABELINGOPTIONS_SPEAKERLABELING.containing_type = _SPEAKERLABELINGOPTIONS
...
_STREAMINGOPTIONS.fields_by_name['speaker_labeling'].message_type = _SPEAKERLABELINGOPTIONS
...
_RECOGNIZEFILEREQUEST.fields_by_name['speaker_labeling'].message_type = _SPEAKERLABELINGOPTIONS
...
DESCRIPTOR.message_types_by_name['SpeakerLabelingOptions'] = _SPEAKERLABELINGOPTIONS
